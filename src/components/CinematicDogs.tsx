...
export default function CinematicDogs({ active }: { active: boolean }) {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[180] overflow-hidden">
      ...
      <div className="absolute left-[18%] bottom-[12%] w-[450px] h-[450px] animate-dog0">
      ...
      <div className="absolute right-[18%] bottom-[12%] w-[450px] h-[450px] animate-dog1">
      ...
      <div className="absolute inset-x-0 bottom-[55%] flex justify-center ml-[-40px] mb-[20px] opacity-0 animate-bubblePop">
